...
public class MyRobot extends FrettedInstrument{
    ...
    //    this.portControl = new PortControl("COM5",9600);  //need Arduino
    }
...
//Need Arduino card connected to computer to work, will crash MyRobot otherwise 
...
*/          
    ...
    public static void main(String[] args) {
        ...
        try {
            MyRobot myRobot = new MyRobot(12, l, "laplap", 6, "/laplap", InetAddress.getByName("200.137.72.164"),
                    12345, 1234, "Fretted", specificP);
            
            myRobot.handshake();
            myRobot.listenThread();
        //    myRobot.msgToArduino();  //Need Arduino
